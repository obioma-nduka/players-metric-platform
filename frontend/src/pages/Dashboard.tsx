  ...
  return (
    <div className="platform-card" style={{ marginBottom: "1.5rem" }}>
      ...
      >
        {r === "admin" && (
          <p style={{ margin: 0 }}>
            You have full access. Use <Link to="/users">Users</Link> for roles
            and assignments, create or edit teams below, and open{" "}
            <Link to="/metric-types">Metric types</Link>,{" "}
            <Link to="/settings">Settings</Link>,{" "}
            <Link to="/reports">Reports</Link>, and export from the players
            directory or reports as needed.
          </p>
        )}
        {r === "head_coach" && (
          <p style={{ margin: 0 }}>
            Create your organization’s teams here, open each team’s{" "}
            <strong>View players</strong> to build the roster, and use{" "}
            <strong>Assign coaches</strong> to attach assistant coaches. Use the
            navbar links for metrics, reports, and settings you are allowed to
            use.
          </p>
        )}
        {r === "coach" && (
          <p style={{ margin: 0 }}>
            <strong>Step 1:</strong> Create your team with the form below (one
            team per coach account). <strong>Step 2:</strong> Open{" "}
            <strong>View players</strong> to add athletes and manage the roster.
            Your account is linked to that team automatically. If you still see
            another club from old data, ask an admin to clear your team
            assignment or use your new team only.
          </p>
        )}
        {(r === "medical_staff" || r === "fitness_coach") && (
          <p style={{ margin: 0 }}>
            Open the <Link to="/players-directory">Players directory</Link>,
            pick a team filter, then a player to add or edit health records. Use{" "}
            <Link to="/reports">Reports</Link> for medical summaries when
            available.
          </p>
        )}
        {r === "performance_analyst" && (
          <p style={{ margin: 0 }}>
            Browse the <Link to="/players-directory">Players directory</Link>{" "}
            for metrics and history, open <Link to="/reports">Reports</Link> for
            analytical views, and export data where your role allows.
          </p>
        )}
        {r === "player" && (
          <p style={{ margin: 0 }}>
            Complete <Link to="/my-profile">My profile</Link> and track your
            data under <Link to="/my-metrics">My metrics</Link>. Your team is
            assigned by staff; you cannot change it yourself.
          </p>
        )}
        {r &&
          ![
            ...
            <p style={{ margin: 0 }}>
              Use the navigation links for the tools available to your role.
            </p>
          )}
      </div>
    </div>
...
export default function Dashboard() {
    ...
    try {
      await createTeam({
        ...
        founded_year: newTeam.founded_year
          ? parseInt(newTeam.founded_year, 10)
          : undefined,
      });
      setNewTeam({
        name: "",
  ...
  const handleSaveTeam = async (e: FormEvent) => {
    ...
    try {
      await updateTeam(editingTeamId, {
        ...
        founded_year: editTeam.founded_year
          ? parseInt(editTeam.founded_year, 10)
          : undefined,
  ...
  const showCreateTeamForm =
    canManageTeams(user?.role) && (user?.role !== "coach" || !userCreatedTeam);
  const accountName = formatAccountName(user?.email);
  ...
  return (
    <div>
      <div style={{ marginBottom: "1.5rem" }}>
        ...
        >
          <h1 className="platform-page-title" style={{ margin: 0 }}>
        ...
        <p className="platform-page-subtitle" style={{ marginBottom: 0 }}>
          ...
          >
            ...
            <div style={{ minWidth: "120px" }}>
              ...
              <input
                ...
                value={newTeam.sport}
                onChange={(e) =>
                  setNewTeam((t) => ({ ...t, sport: e.target.value }))
                }
                className="platform-input"
            ...
            <div style={{ minWidth: "120px" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewTeam((t) => ({ ...t, league: e.target.value }))
                }
                className="platform-input"
                placeholder="League"
              />
            ...
            <div style={{ minWidth: "120px" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewTeam((t) => ({ ...t, country: e.target.value }))
                }
                className="platform-input"
                placeholder="Country"
              />
            ...
            <div style={{ minWidth: "100px" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setNewTeam((t) => ({ ...t, founded_year: e.target.value }))
                }
                className="platform-input"
                placeholder="Year"
                min="1800"
            ...
            <button
              ...
              disabled={createTeamLoading || !newTeam.name.trim()}
            >
          ...
          >
            <div style={{ minWidth: "160px" }}>
              ...
              <input
                ...
                value={editTeam.name}
                onChange={(e) =>
                  setEditTeam((t) => ({ ...t, name: e.target.value }))
                }
                required
              />
            </div>
            <div style={{ minWidth: "120px" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditTeam((t) => ({ ...t, sport: e.target.value }))
                }
              />
            </div>
            <div style={{ minWidth: "120px" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditTeam((t) => ({ ...t, league: e.target.value }))
                }
              />
            </div>
            <div style={{ minWidth: "120px" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditTeam((t) => ({ ...t, country: e.target.value }))
                }
              />
            </div>
            <div style={{ minWidth: "100px" }}>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditTeam((t) => ({ ...t, founded_year: e.target.value }))
                }
              />
            </div>
            <label
            ...
            >
              <input
                ...
                onChange={(e) =>
                  setEditTeam((t) => ({ ...t, is_active: e.target.checked }))
                }
              />
              Active
            </label>
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      {team.sport || "Football"} • {team.league || "N/A"} •{" "}
                      {team.country || "N/A"}
                      {" • "}
                      {Number(team.player_count) || 0}{" "}
                      {Number(team.player_count) === 1 ? "player" : "players"}
                    </p>
                  </div>
                  <div
                  ...
                  >
                    <button
                      ...
                      className="platform-btn platform-btn-primary"
                      onClick={() =>
                        navigate(`/dashboard/team/${team.team_id}/players`)
                      }
                    >
                      View Players
                    </button>
                    ...
                    {canAssignTeamCoaches(user?.role) &&
                      (user?.role === "admin" ||
                        ...
                        <button
                          ...
                          className="platform-btn platform-btn-secondary"
                          onClick={() =>
                            navigate(`/dashboard/team/${team.team_id}/staff`)
                          }
                        >
                          Assign coaches
                        </button>
      ...
      >
        ...
        {canManageTeamRoster(user?.role) &&
          (user?.role === "head_coach" || user?.role === "coach") && (
            <div className="platform-card" style={{ padding: "1.25rem" }}>
              ...
              >
                Pick a team under Your Teams and use{" "}
                <strong>View players</strong> to add or move players on your
                squad.
              </p>
            </div>
          )}
          ...
          <div className="platform-card" style={{ padding: "1.25rem" }}>
            ...
            >
              ...
              {canAddHealthRecords(user?.role)
                ? " and open records to update health metrics."
                : "."}
            </p>
          </div>
        )}
        {canGenerateMedicalReports(user?.role) && (
          <div className="platform-card" style={{ padding: "1.25rem" }}>
            ...
            >
              <Link to="/reports">Open Reports</Link> for medical summaries and
              filters.
            </p>
          </div>
        )}
          ...
          <div className="platform-card" style={{ padding: "1.25rem" }}>
            ...
            >
              ...
              {canExportData(user?.role)
                ? " and export from the directory or reports flows."
                : "."}
            </p>
          </div>
        )}
        {canManageMetricTypes(user?.role) && (
          <div className="platform-card" style={{ padding: "1.25rem" }}>
            ...
            >
              <Link to="/metric-types">Configure metric types</Link> used across
              the platform.
            </p>
          </div>
        )}
